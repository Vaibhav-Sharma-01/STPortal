...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    <img alt="whoops... something went wrong" src="images/ABESEC_logo.png" height="20%">
    <a href="Admin.jsp">Dashboard</a>
    <a href="logout">Logout</a>
  </div>
</div>

<section class="w3l-banner-slider-main" onclick="openNav()" id="abc">
				<div class="carousel-item button-4 mx-auto">
								<div class="eff-4"></div>
								<a href="#" style="font-size:30px;cursor:pointer">&#9776; open</a>
