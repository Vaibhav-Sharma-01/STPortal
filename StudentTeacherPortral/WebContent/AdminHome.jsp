...
%>
<div style="height: 85vh;font-family:'Aclonica'; ">
	<form action="profileadmin" method="post"
		...
		<div class="row" style="margin: 1px;">
			...
			<div class="col-sm-10"
				style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); transition: 0.3s;background-color: #17a2b8cc; border-radius: 10px">

				<h1 align="center" class="hh" style="font-family:'Aclonica';"><i>${name}</i></h1>
				<hr class="new1">
				...
				<div class="col-md-4">
					...
					<div class="form-group">
						<label for="price" class="hh">Name:</label> <input type="text"
							class="form-control hh" id="name"
							value="${name}" placeholder="Enter Name" readonly>
					</div>
					<div class="form-group">
						<label for="name" class="hh">Email id:</label> 
							<input type="email"
