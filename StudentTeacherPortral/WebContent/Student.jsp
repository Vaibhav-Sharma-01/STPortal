...
<div style="height: 80vh;">
			...
			<div class="col-sm-10"
				...
				<div class="col-md-4">
					...
					<div class="form-group">
						<label for="price" class="hh">Roll No:</label> <input type="text"
							class="form-control hh" id="email" name="roll"
							value="${roll}" placeholder="Enter Roll No" readonly>
					</div>
					<div class="form-group">
    ...
    <hr class="new1">
  <center><h5 style="color:white;font-family: 'Almendra Display';font-size: 22px;"><b>Note: Any errors occur then contact BTech Days.
Designed & Developed by BTech Days Team</b></h5></center>
  <hr class="new1">
<center><h5 style="color: white;font-family: 'Almendra Display';font-size: 22px;"><b>All Right Reserved @ BTech Days :: 2015-2020</b></h5></center> 
  <hr class="new1">
<br>